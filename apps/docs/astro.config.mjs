...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      description:
        "Self-hosted platform that documents, plans, fixes and watches your repositories with an AI worker: autogenerated docs, backlog synced with Claude Code, tickets that become pull requests.",
      defaultLocale: "en",
      locales: {
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Gmail and Calendar", slug: "integrations/gmail-calendar" },
          ],
        ...
        },
        {
          label: "Documentation",
          items: [
            { label: "Autogenerated docs", slug: "documentation/autogenerated" },
            { label: "Code graph (graphify)", slug: "documentation/code-graph" },
          ],
        },
        {
          label: "Team & planning",
